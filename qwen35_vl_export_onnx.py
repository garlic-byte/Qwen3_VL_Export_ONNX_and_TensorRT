...
from modules import Qwen35VLTextModelOpt, Qwen35VLVisualModelOpt, Qwen35VLModelOpt, Qwen35VLForConditionalGenerationOpt
...
def run_export(config: ArgsConfig):
    ...
    for part_model_name in part_qwen_model.keys():
